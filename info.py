...
BOT_TOKEN = environ.get('BOT_TOKEN', "6040310745:AAGvwdJUW4G0f1Ox0ihFWGFESzx9feL3Msk")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://graph.org/file/07f74a2678afcb1eecf80.jpg')).split() #SAMPLE PIC
...
URL = "https://thalapathy-2-fol3.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://lucy-ehcx.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://lucy-ehcx.onrender.com/".format(FQDN)
else:
    URL = "https://lucy-ehcx.onrender.com/".format(FQDN)
